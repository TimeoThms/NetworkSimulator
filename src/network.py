...
pc2 = Computer("PC-02", "192.168.1.254")
pc2.interfaces["eth0"].ipv4 = "192.168.1.2"
...
# Interfaces
pc1.interfaces["eth0"].connect(s1.interfaces["eth0"], LinkType.ETHERNET)
...
pc1.send_packet(Packet("192.168.1.1", "192.168.1.2", "Hello"))